...
**Source-reviewed status (2026-09-20, `combat` @ `23cda8f4567429157e1277d6772128e8f9d574ac`):** Shared actor/baddie melee, optional Angriff/Treffer states and hit feedback, ranged projectiles with gravity and mouse aiming/click firing, and delayed bombs with one-shot Zündschnur/Explosion, optional shake and owner self-damage are present. The user tested the latest mouse-click/bomb-wall patch in the game and committed it. No comprehensive legacy-game test is claimed. General stomp/area authoring, lasers, cooldown HUD, consumable ammunition/pickups and published browser-rendered recipes remain separate proposals. Reinspect HEAD before another patch.
...
**Next action (deferred combat):** Pause finite ranged ammunition and further attack deliveries while seamless interiors are designed/implemented. When combat resumes, make one separately testable feature per patch and publish German recipes only after checking them against the real engine. Do not modify GitHub on the user's behalf.
