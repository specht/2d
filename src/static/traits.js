...
var STATE_TRAITS = {
    actor: {
        ...
        left: { label: 'links' },
        right: { label: 'rechts' },
        walk_front: { label: 'vorn' },
        walk_back: { label: 'hinten' },
        walk_left: { label: 'links' },
        walk_right: { label: 'rechts' },
        jump_front: { label: 'vorn' },
        jump_back: { label: 'hinten' },
        jump_left: { label: 'links' },
        jump_right: { label: 'rechts' },
        fall_front: { label: 'vorn' },
        fall_back: { label: 'hinten' },
        fall_left: { label: 'links' },
        fall_right: { label: 'rechts' },
        attack_front: { label: 'vorn' },
        attack_back: { label: 'hinten' },
        attack_left: { label: 'links' },
        attack_right: { label: 'rechts' },
        hit_front: { label: 'vorn' },
        hit_back: { label: 'hinten' },
        hit_left: { label: 'links' },
        hit_right: { label: 'rechts' },
